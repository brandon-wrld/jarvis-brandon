...
create_project
  prompt: string (required) — the project idea/spec to send to Claude
  auto_send: boolean (optional, default false) — send immediately instead of leaving it for the user to review
EXAMPLES:
...
Goal: "Create a project for a personal budgeting app"
Steps:

create_project | prompt: "Build a personal budgeting app that tracks income, expenses, and monthly savings goals."

Goal: "Create a project to build a recipe finder website and send it"
Steps:

create_project | prompt: "Build a recipe finder website where users can search recipes by ingredients they have on hand.", auto_send: true
